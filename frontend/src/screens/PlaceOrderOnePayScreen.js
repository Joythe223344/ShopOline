...
const PlaceOrderOnePayScreen = ({ history }) => {
  window.scrollTo(0, 0);
      ...
      <div className="container">
        ...
        <div className="row order-products justify-content-between">
          ...
          <div className="col-lg-3 d-flex align-items-end flex-column mt-5 subtotal-order">
            ...
            <div>
              <img className="QRCode-style" src={QRCODE} alt="QRCODE" />
            </div>

            <form className="custom-upload-image">
              <input
                id="images"
                className="d-none"
                type="file"
              ...
              />
              <label htmlFor="images" className="custom-label">
                {imageName ? <p>{imageName.name}</p> : <p>Upload Image Here</p>}
              </label>
            </form>
        ...
        <div className="box-free"></div>
      </div>
    </>
  );
};

export default PlaceOrderOnePayScreen;
